...
class Uploader_UploadHandler
{
    ...
    /**
     * Initialise passed in options and run appropriate request
     *
     * If extending this method (eg to customise options), call
     * parent::initialize(); at the end so passed in options have highest priority
     */
        ...
        if ($this->validate($uploaded_file, $file, $error, $index)) {
            ...
            if ($file_size === $file->size) {
                ...
                if (!$content_range && $this->options['discard_aborted_uploads']) {
                    unlink($file_path);
                    $file->error .= 'Upload aborted - could not create file';
                }
            }
            $this->set_additional_file_properties($file);
        }
