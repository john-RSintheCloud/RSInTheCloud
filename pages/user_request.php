...
if (getval("save", "") != "") {
    ...
    elseif (user_email_exists(getval("email", ""))) {
        ...
        $error_extra = "<br/><a href=\"" . $baseurl_short . "pages/user_password.php?email=" . urlencode(getval("email",
                                "")) . "\">" . $lang["forgottenpassword"] . "</a>";
    } else {
        # E-mail is unique
                ...
                ?>">
                    <?php } ?>
                        ...
                        <?php if ($type == 2) { # Large text box
                            ?>
                        <textarea name="custom<?php echo $n ?>" id="custom<?php echo $n ?>" class="stdwidth" rows="5"><?php echo htmlspecialchars(getvalescaped("custom" . $n,
                                ""))
                            ?></textarea>
                        <?php } ?>
...
<?php } /* END hook Replacegroupselect */ ?>
        ...
        <div class="Question">
            ...
            <textarea name="userrequestcomment" id="userrequestcomment" class="stdwidth"><?php echo htmlspecialchars(getvalescaped("userrequestcomment",
                            ""))
            ?></textarea>
            <div class="clearerleft"> </div>
        </div>
