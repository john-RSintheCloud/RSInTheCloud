...
$url = $baseurl_short . "pages/team/team_user_edit.php?ref=" . getvalescaped("ref",
                "", true);
...
/**
 * Extract browser and os from $agent
 * @param string $agent
 * @return string
 */
...
if (getval("unlock", "") != "") {
    ...
    if ($result === false) {
        ...
        if (getval("save", "") != "") {
            $backurl = getval("backurl",
                    $baseurl_short . "pages/team/team_user.php?nc=" . time());
            redirect($backurl);
        }
    }
}
...
<?php if (isset($error)) { ?><div class="FormError">!! <?php echo $error ?> !!</div><?php } ?>
    ...
    <form method=post action="<?php echo $baseurl_short ?>pages/team/team_user_edit.php">
        ...
        <input type=hidden name=backurl value="<?php echo getval("backurl",
        $baseurl_short . "pages/team/team_user.php?nc=" . time()) ?>">
...
<?php } ?>
        ...
        <div class="Question"><label><?php echo $lang["lastbrowser"] ?></label>
            <div class="Fixed"><?php echo resolve_user_agent($user["last_browser"],
                true) ?></div>
            <div class="clearerleft"> </div></div>
