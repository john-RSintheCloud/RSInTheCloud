...
$container['model_asset'] = function ($c) {
    $model = new resource_model_assetAbstract();
...
$container['model_basket'] = function ($c) {
    $model = new resource_model_basket();
    $model->setDbClass($c['table_basket']);
    return $model;
        };

//  Resource model requires table injection
$container['model_resource'] = function ($c) {
    $model = new resource_model_resource();
    $model->setDbClass($c['table_resource']);
    return $model;
        };
